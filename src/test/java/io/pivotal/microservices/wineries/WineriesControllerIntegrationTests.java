...
@SpringBootTest(classes = WineriesConfiguration.class, properties = { "eureka.client.enabled=false" })
public class WineriesControllerIntegrationTests extends AbstractWineryControllerTests {
